...
1.  **Token management** — store/get/remove/list tokens in process
    environment variables (never written to disk), namespaced per
    service.
2.  **Request building** — pluggable **authentication** and
    **pagination** strategies, bundled into a reusable API *profile*.
...
[BigDataPE](https://github.com/StrategicProjects/BigDataPE) package;
