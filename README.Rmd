...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/apifetch)](https://CRAN.R-project.org/package=apifetch)
...
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/apifetch)](https://CRAN.R-project.org/package=apifetch)
[![Python sibling](https://img.shields.io/pypi/v/apifetch?label=python%20sibling&logo=python&logoColor=white)](https://pypi.org/project/apifetch/)
<!-- badges: end -->
